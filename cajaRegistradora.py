...
#         print(f"Dinero actualmente en caja: {self.efectivo}")

#     def procesar_venta(self):
#         precioVenta = 500
#         self.efectivo = self.efectivo + precioVenta
#         print(f"Dinero luego de una venta: {self.efectivo}")

# caja_1 = cajaRegistradora()

# caja_1.efectivo = 25000

# caja_1.mostrar_dinero_actual()
# caja_1.procesar_venta()
